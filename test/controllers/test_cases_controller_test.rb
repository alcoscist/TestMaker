...
class TestCasesControllerTest < ActionController::TestCase
  ...
  test "should create test_case" do
    assert_difference('TestCase.count') do
      post :create, test_case: { TestType: @test_case.TestType, action: @test_case.action, expectedResult: @test_case.expectedResult }
    end
  ...
  test "should update test_case" do
    patch :update, id: @test_case, test_case: { TestType: @test_case.TestType, action: @test_case.action, expectedResult: @test_case.expectedResult }
    assert_redirected_to test_case_path(assigns(:test_case))
  end
